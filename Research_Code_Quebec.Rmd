...
research1.df = read.csv("C:\\Users\\Alyssa Dollente\\Downloads\\DATA 501 L01\\Research Project\\Dataset - Provinces\\Deaths_1x1_Quebec.csv")
research1.df
```
...
# Save as a CSV file
write.csv(excess_mortality_comparison, "Pandemic_Excess_Mortality_Quebec_i.csv", row.names = FALSE)
```
...
saveWorkbook(wb, "Pandemic_Excess_Mortality_Quebec.xlsx", overwrite = TRUE)
